...
//    private var camera: CameraWrapper? = null
    ...
    init {
        methodChannel = MethodChannel(messenger, "plugins.flutter.io/yourinrolltoolsstream")
        imageStreamChannel = EventChannel(messenger, "plugins.flutter.io/yourinrolltoolsstream/imageStream")
