#import "YourinrolltoolsstreamPlugin.h"
#if __has_include("yourinrolltoolsstream/yourinrolltoolsstream-Swift.h")
#import <yourinrolltoolsstream/yourinrolltoolsstream-Swift.h>
#else
// Support project import fallback if the generated compatibility header
// is not copied when this plugin is created as a library.
// https://forums.swift.org/t/swift-static-libraries-dont-copy-generated-objective-c-header/19816
#import "yourinrolltoolsstream-Swift.h"
#endif
...
- (void)startImageStreamWithMessenger:(NSObject<FlutterBinaryMessenger> *)messenger {
    if (!_isStreamingImages) {
        ...
        [FlutterEventChannel eventChannelWithName:@"plugins.flutter.io/yourinrolltoolsstream/imageStream"
...
@interface YourinrolltoolsstreamPlugin ()
@property(readonly, nonatomic) NSObject<FlutterTextureRegistry> *registry;
@property(readonly, nonatomic) NSObject<FlutterBinaryMessenger> *messenger;
@property(readonly, nonatomic) FLTCam *camera;
@end

@implementation YourinrolltoolsstreamPlugin {
    dispatch_queue_t _dispatchQueue;
}
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar> *)registrar {
    FlutterMethodChannel *channel =
    [FlutterMethodChannel methodChannelWithName:@"plugins.flutter.io/yourinrolltoolsstream"
                                binaryMessenger:[registrar messenger]];
    YourinrolltoolsstreamPlugin *instance = [[YourinrolltoolsstreamPlugin alloc] initWithRegistry:[registrar textures]
        ...
        if (error) {
            ...
            FlutterEventChannel *eventChannel = [FlutterEventChannel
                                                 eventChannelWithName:[NSString
                                                                       stringWithFormat:@"plugins.flutter.io/yourinrolltoolsstream/cameraEvents%lld",
                                                                       textureId]
